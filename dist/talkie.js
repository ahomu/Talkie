...
module.exports = function (options) {
  ...
  return {
    current: current,
    start: current.filter(function (v) {
      return v === 1;
    }),
    end: current.filter(function (v) {
