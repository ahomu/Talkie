...
function main() {
  ...
  if (options.backface) {
    ...
    bgFilterBus.map(".getAttribute", ATTR_FILTER).onValue(util.styleAssignOf(backfaceEl, "-webkit-filter"));
