...
function main() {
  ...
  if (options.backface) {
    ...
    // preload
    Bacon.fromArray(slides).map(".getAttribute", IDENT_BACKFACE).filter(function (v) {
      return !!v;
...
module.exports = function (options) {
  ...
  var changed = current.map(function (current) {
