...
function main() {
  ...
  slides.forEach(function (el, i) {
    return util.attributeAssignOf(el, ATTR_PAGE)(i + 1);
  });
  var notes = {};
  slides.map($slide.extractNote).forEach(function (txt, i) {
