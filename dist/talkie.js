...
},{"./control":7,"baconjs":2}],9:[function(require,module,exports){
"use strict";
...
function main() {
  ...
  if (options.pointer) {
    ...
    var _Pointer = Pointer(util.getById(IDENT_POINTER));

    var coordBus = _Pointer.coordBus;
    var toggleBus = _Pointer.toggleBus;
  ...
  if (options.backface) {
    ...
    var _Backface = Backface(util.getById(IDENT_BACKFACE));

    var bgImageBus = _Backface.bgImageBus;
    var bgFilterBus = _Backface.bgFilterBus;
...
},{"./backface":6,"./control":7,"./fullscreen":8,"./markdown":10,"./paging":11,"./pointer":12,"./query":13,"./responsive":14,"./util":15,"babel/browser-polyfill":1,"baconjs":2}],10:[function(require,module,exports){
"use strict";
...
},{"./util":15,"baconjs":2,"marked":4}],11:[function(require,module,exports){
"use strict";
...
},{"./control":7,"./util":15,"baconjs":2}],12:[function(require,module,exports){
"use strict";
...
},{"./util":15,"baconjs":2}],13:[function(require,module,exports){
"use strict";
...
},{"./util":15,"baconjs":2}],15:[function(require,module,exports){
"use strict";
